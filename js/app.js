...
window.approveOrder = async function(pendingId) {
    ...
    try {
        ...
        let mailTo = [{ email: 'admin@pharmacy.com', name: 'إدارة الصيدلية' }];
            ...
            body: JSON.stringify({
                ...
                htmlContent: `
                    <div style="font-family: Arial, sans-serif; direction: rtl; text-align: right; line-height: 1.6;">
                        ...
                        <p><strong>طريقة الاستلام:</strong> ${resDataObj.order_type === 'delivery' ? `توصيل למنزل (${resDataObj.delivery_address})` : 'استلام من الصيدلية'}</p>
                        <hr>
                        <h3>التفاصيل:</h3>
        ...
        statusMsg.textContent = 'تم الاعتماد بنجاح وتم إرسال الإيميل!';
        loadPendingOrders();
